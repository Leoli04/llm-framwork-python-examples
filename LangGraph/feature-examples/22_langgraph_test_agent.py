...
from react_agent_module import perform_search, filter_results, compile_markdown,graph, ReActAgentState
...
class TestReActAgent(unittest.TestCase):
    ...
    def test_filter_results(self, mock_invoke):
        ...
        state = {"query": "", "search_results": ["Python programming", "Best practices", "Code readability"],
                 "markdown_result": ""}
